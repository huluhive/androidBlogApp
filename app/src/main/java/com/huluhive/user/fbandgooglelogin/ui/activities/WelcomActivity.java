...
import com.huluhive.user.fbandgooglelogin.ui.fragments.AddFragment;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add) {
            ...
            if(mSignInAccount!=null) {
                ...
                bundle.putString(GOOGLE_USERNAME, mSignInAccount.getDisplayName());
                addFragment.setArguments(bundle);
            }
            getSupportFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.place_holder,addFragment).commit();
            return true;
        }
